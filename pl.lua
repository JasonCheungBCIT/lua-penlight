do --{{
local sources, priorities = {}, {};assert(not sources["pl.stringx"],"module already exists")sources["pl.stringx"]=([===[-- <pack pl.stringx> --
...
assert(not sources["pl.stringio"],"module already exists")sources["pl.stringio"]=([===[-- <pack pl.stringio> --
